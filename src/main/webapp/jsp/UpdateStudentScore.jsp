...
<%
    try{
        ...
        String updateStudentScore = "update ScoreInfo set studentScore =? where studentId = ? and subjectId =?";
        PreparedStatement ps = conn.prepareStatement(updateStudentScore);
        ps.setString(1, request.getParameter("studentScore"));
